package com.isoftzone.vendor.adapter;
...
import com.isoftzone.vendor.activity.SubCategoryActivity;
...
public class HomeGridAdapter extends RecyclerView.Adapter<HomeGridAdapter.MyViewHolder> {
    ...
    public HomeGridAdapter(ArrayList<MainCategoryBean> homeModelArrayList, ImageLoader imageLoader, Context context,
    ...
    @NonNull
    @Override
    public HomeGridAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_menu_grid_row, parent, false);
